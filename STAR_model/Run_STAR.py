...
if __name__ == "__main__":  
    ...
    # keys=samples.keys() #['w_(1, 2)','y_(2, 2),(11, 2)','y_(11, 2),(2, 2)']
    ...
    # save_trace_and_data(train_data,test_data,trace,initial_net,samples,network_objects)
    # ppc,ppc_test = STAR_utils.test_model(train_data,test_data,trace,model)

    # samples,network_objects,initial_net_G = pickle.load( open( "initial_data.pkl", "rb" ))  
