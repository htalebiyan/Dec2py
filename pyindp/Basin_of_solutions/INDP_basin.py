...
#     pickle.dump([results, optimal_tc, optimal_act_conv], f)        
''' Plot '''
with open('results.pkl', 'rb') as f:
    [results, optimal_tc, optimal_act_conv] = pickle.load(f)
...
kwargs  =   {'edgecolor':"k", # for edge color
             'linewidth':0.1, # line width of spot
...
g.annotate('INDP', xy=(str(optimal_act_conv), optimal_tc),
           xytext=(.5*offset, offset), textcoords='offset points',
