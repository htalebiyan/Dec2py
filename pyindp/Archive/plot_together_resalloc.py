...
#selected_df = selected_df.rename(columns={"distance_to_optimal": "distance to optimal",
#                                          "auction_type": "Auction Type",
#                                          "topology":"Topology"})
#
#g = sns.catplot(x=' No. Layers', y='distance to optimal', hue='Auction Type',
...
#f, ax = plt.subplots()
#sns.scatterplot(x="distance_to_optimal", y=" Interconnection Prob",
...
#                 selected_df[selected_df[' No. Layers']==4]["distance_to_optimal"],
#                 cmap="Blues", shade=True, shade_lowest=False)

#sns.relplot(x=" Damage Prob", y="distance_to_optimal",
