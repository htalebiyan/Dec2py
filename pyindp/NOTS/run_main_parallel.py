...
def run_parallel(i):
    ...
    #'/scratch/ht20/random_disruption_shelby/'
	#'/scratch/ht20/random_disruption_shelby/'
    ...
    # runutils.run_method(fail_sce_param, rc, layers, method='TD_INDP', output_dir=output_dir, 
			   # misc = {'DYNAMIC_PARAMS':dynamic_params_dir})
    runutils.run_method(fail_sce_param, rc, layers, method='BAYESGAME', judgment_type=judge_type, res_alloc_type=res_alloc_type, valuation_type=val_type, output_dir=output_dir,
               misc=misc)
