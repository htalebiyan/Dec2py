...
if __name__ == "__main__":
    ...
    # REF_METHOD = 'indp'
    # METHOD_NAMES = ['dp_indp', 'dp_jc'] #'indp', 'ng', 'jc', 'dp_indp', 'tdindp' ''bgCCCCUUUU'
    ...
    plots.plot_performance_curves(BASE_DF[(BASE_DF['no_resources']=='b120000t70')|\
                                          (BASE_DF['no_resources']=='b120000t105')|\
